...
const STORAGE_KEY = "onlinesadar_currency";
const MANUAL_KEY = "onlinesadar_currency_manual";
const RATE_CACHE_KEY = "onlinesadar_usd_inr_rate";
const RATE_CACHE_AT_KEY = "onlinesadar_usd_inr_rate_at";
