...
export function ExitIntentPopup() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus("idle");
      setError(err instanceof Error ? err.message : "Could not send offer email. Try again or email support@halloweenready.com.");
    }
  };
        ...
        {status === "done" ? (
          <div className="text-center py-4">
            ...
            {coupon ? (
              ...
              <p className="text-sm text-slate-600 mb-3">
                Check your inbox for your 10% first-order offer. Order soon — Halloween is August 28, 2026.
              </p>
            )}
            <Link
              href="/products"
