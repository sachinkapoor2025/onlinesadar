          ...
          <aside className="space-y-6">
            ...
            <section className="bg-nav text-white rounded-xl p-6">
              ...
              <p className="text-sm text-white/90 mb-4">
                Browse our collections above or reach out — we help sisters worldwide place Halloween orders.
              </p>
              <div className="flex flex-wrap gap-3 text-sm">
                ...
                <a
                  href={whatsappChatUrl("Hi HalloweenReady, I want to send rakhi to the USA.")}
                  target="_blank"
